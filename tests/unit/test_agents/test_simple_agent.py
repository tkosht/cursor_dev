...
class TestSimpleTestAgentUserInputProcessing:
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_echo_command_with_message(self, sample_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_echo_command_without_message(self, sample_agent_config):
    ...
    @pytest.mark.asyncio 
    async def test_process_user_input_echo_command_with_only_spaces(self, sample_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_status_command(self, sample_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_question_mark_help(self, sample_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_unknown_command(self, sample_agent_config):
...
class TestSimpleTestAgentConfiguration:
    ...
    def test_agent_config_modification_affects_agent(self, sample_agent_config):
        """設定の変更がエージェントに反映される"""
        # Given: SimpleTestAgent
        agent = SimpleTestAgent(sample_agent_config)
...
class TestSimpleTestAgentEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_only_whitespace(self, sample_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_process_user_input_very_long_input(self, sample_agent_config):
