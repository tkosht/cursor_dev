...
from .interfaces import IAgent, IEnvironment, IAction, IPlugin, ISimulation
from .types import (
    AgentID,
    SimulationState,
    ActionResult,
...
class BaseAgent(IAgent):
    ...
    def __init__(self, agent_id: Optional[AgentID] = None, attributes: Optional[PersonaAttributes] = None):
