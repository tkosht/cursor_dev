...
class PersonaAttributes(BaseModel):
    ...
    cognitive_biases: list[str] | None = Field(default=None, description="認知バイアス")
    emotional_triggers: list[str] | None = Field(default=None, description="感情的トリガー")
    income_bracket: str | None = Field(default=None, description="収入層")
    decision_making_style: str | None = Field(default=None, description="意思決定スタイル")
    content_sharing_likelihood: float | None = Field(default=None, description="コンテンツ共有確率")
    influence_susceptibility: float | None = Field(default=None, description="影響受容性")
    # Network-related optional attributes used in tests
    social_influence_score: float | None = Field(default=None, description="社会的影響スコア")
    network_size: str | None = Field(default=None, description="ネットワーク規模")
...
class EvaluationResult(BaseModel):
    ...
    article_id: str | None = Field(default=None, description="評価した記事のID")
...
class PersonaDemographics(BaseModel):
    ...
    income_bracket: str | None = Field(None, description="収入層")
...
class SimulationConfig(BaseModel):
    ...
    focus_segments: list[str] | None = Field(None, description="重点セグメント")
