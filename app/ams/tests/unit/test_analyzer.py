...
"""
    ...
    async def test_analyze_success(
        self, mock_create_llm, mock_select_llm, mock_get_config, sample_article, mock_llm_response
    ):
    ...
    @patch("src.agents.analyzer.select_optimal_llm")
    @patch("src.agents.analyzer.create_llm")
    async def test_analyze_with_errors(
        self, mock_create_llm, mock_select_llm, mock_get_config, sample_article
    ):
