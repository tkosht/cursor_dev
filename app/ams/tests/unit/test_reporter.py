...
from src.core.types import EvaluationMetric, EvaluationResult, PersonaAttributes, PersonalityType, InformationChannel
...
class TestReporterAgent:
    ...
    def test_calculate_confidence_score(self, minimal_state):
        ...
        confidence_high = agent._calculate_confidence_score(
            persona_count=50,
            score_variance=2.0
        )
