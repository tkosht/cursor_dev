...
class TestNetworkEffectSimulator:
    ...
    @pytest.mark.asyncio
    async def test_network_node_creation(self, simulator, sample_personas, article_analysis, real_llm):
    ...
    @pytest.mark.asyncio
    async def test_propagation_simulation(self, simulator, sample_personas, article_analysis, real_llm):
    ...
    async def test_edge_generation(self, simulator, sample_personas, article_analysis, real_llm):
        ...
        for edge in simulator.edges[:5]:  # Check first 5 edges
            ...
            assert edge.relationship_type in [
                "mentor-follower", "peer", "influencer-audience", "social"
            ]
    
    @pytest.mark.asyncio
    async def test_propagation_probability_calculation(self, simulator, sample_personas, article_analysis):
    ...
    async def test_network_metrics(self, simulator, sample_personas, article_analysis, real_llm):
        ...
        result = await simulator.simulate_propagation(
            initial_seeds=["persona_0", "persona_1"],
            content_score=0.6,
            max_timesteps=3
        )
    ...
    async def test_influence_score_calculation(self, simulator):
        ...
        ceo_persona = PersonaAttributes(
            ...
            personality_traits={
                ...
                PersonalityType.EXTRAVERSION: 0.9
            },
    ...
    @pytest.mark.asyncio
    async def test_propagation_events_recording(self, simulator, sample_personas, article_analysis, real_llm):
