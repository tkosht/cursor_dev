...
from src.agents.persona_design_orchestrator import (
    PersonaDesignOrchestrator,
    PersonaDesign
)
from src.agents.target_audience_analyzer import AudienceSegment, AudienceAnalysis
...
class TestPersonaDesignOrchestrator:
    ...
    @pytest.mark.asyncio
    async def test_orchestrate_persona_generation_small(self, orchestrator, tech_article_content, article_analysis, real_llm):
    ...
    async def test_persona_distribution_design(self, orchestrator):
        ...
        audience_analysis = AudienceAnalysis(
            ...
            engagement_distribution={"Tech Professionals": 0.5, "Business Leaders": 0.3, "Researchers": 0.2},
    ...
    @pytest.mark.asyncio
    async def test_unique_persona_generation(self, orchestrator, tech_article_content, article_analysis, real_llm):
        ...
        # Create mock audience analysis
        audience_analysis = type('obj', (object,), {
            'demographic_insights': {
    ...
    async def test_persona_validation_and_diversity(self, orchestrator):
        ...
        assert len(set(occupations)) > 1 or any("Senior" in occ or "Junior" in occ for occ in occupations)
