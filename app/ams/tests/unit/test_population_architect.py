...
class TestPopulationArchitect:
                ...
                with patch.object(architect, '_design_micro_clusters') as mock_micro:
                    ...
                    with patch.object(architect, '_allocate_persona_slots') as mock_slots:
                        ...
                        with patch.object(architect, '_design_network_topology') as mock_network:
                            ...
                            with patch.object(architect, '_design_influence_patterns') as mock_influence:
    ...
    async def test_allocate_persona_slots(self, architect):
        ...
        sub_segments = {
            ...
            "laggards": [
                {"id": "skeptics", "percentage_of_parent": 100}
            ]
        }
    ...
    async def test_design_influence_patterns(self, architect):
        ...
        assert len(influence_map["influencer_nodes"]) < len(persona_slots)  # Not everyone is an influencer
