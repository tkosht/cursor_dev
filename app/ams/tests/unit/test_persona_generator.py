...
class TestPersonaGenerator:
    ...
    def sample_population_structure(self):
        ...
        return {
            ...
            "network_topology": {"network_type": "small-world", "density": 0.3},
            "influence_map": {
    ...
    async def test_generate_personas_structure(
        self, generator, sample_article, sample_analysis_results, sample_population_structure
    ):
    ...
    async def test_design_population_integration(self, generator, sample_analysis_results):
        ...
        with patch.object(
            ...
            mock_design.assert_called_once_with(sample_analysis_results, target_size=10)
    ...
    def test_convert_to_persona_attributes(self, generator):
        ...
        persona_data = {
            ...
            "article_relationship": {"relevance_score": 0.8, "sharing_likelihood": 0.6},
        }
    ...
    async def test_error_handling(self, generator, sample_article, sample_analysis_results):
        ...
        with patch.object(generator, "_analyze_context") as mock_context:
            ...
            result = await generator.generate_personas(
                article_content=sample_article, analysis_results=sample_analysis_results, count=5
            )
