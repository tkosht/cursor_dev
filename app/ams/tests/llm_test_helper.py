...
class LLMTestHelper:
    ...
    def _init_gemini(self):
        ...
        try:
            ...
            self.llm = ChatGoogleGenerativeAI(
                model=model_name, google_api_key=api_key, temperature=0.7, max_tokens=1000
            )
    ...
    async def generate(
        self, prompt: str, use_cache: bool = True, system_prompt: str | None = None
    ) -> str:
        """
    ...
    def generate_structured(
        self, prompt: str, schema: dict[str, Any], use_cache: bool = True
    ) -> dict[str, Any]:
        """
...
_llm_helper: LLMTestHelper | None = None
