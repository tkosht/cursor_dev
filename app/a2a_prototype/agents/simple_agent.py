...
class SimpleTestAgent(BaseA2AAgent):
    ...
    async def process_user_input(self, user_input: str) -> str:
        ...
        if input_lower.startswith("hello") or input_lower.startswith("hi"):
            return f"Hello! I'm {self.config.name}. How can I help you today?"
            ...
            return f"I'm {self.config.name} running on {self.config.url}. Status: OK"
            ...
            return f"I received: '{user_input}'. Try 'help' for available commands."
